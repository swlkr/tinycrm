...
class FetchRequest {
  constructor(delegate, method, location2, body = new URLSearchParams()) {
...
class FrameController {
  ...
  get isLoading() {
    return this.formSubmission !== void 0 || this.loadingURL !== void 0;
  }
  get isActive() {
...
class Navigator {
  ...
  proposeVisit(location2, options = {}) {
    if (this.delegate.allowsVisitingLocation(location2)) {
...
class Session {
  ...
  historyPoppedToLocationWithRestorationIdentifier(location2) {
    if (this.enabled) {
      this.navigator.proposeVisit(location2, {action: "restore", historyChanged: true});
    } else {
  ...
  willFollowLinkToLocation(link, location2) {
    return this.elementIsNavigable(link) && this.locationIsVisitable(location2) && this.applicationAllowsFollowingLinkToLocation(link, location2);
  }
  followedLinkToLocation(link, location2) {
    const action = this.getActionForLink(link);
    this.visit(location2.href, {action});
  }
  allowsVisitingLocation(location2) {
  ...
  visitStarted(visit2) {
    ...
    this.notifyApplicationAfterVisitingLocation(visit2.location);
  }
  visitCompleted(visit2) {
  ...
  notifyApplicationAfterVisitingLocation(location2) {
    return dispatch("turbo:visit", {detail: {url: location2.href}});
  }
